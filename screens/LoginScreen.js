...
export default function LoginScreen({ navigation }) {
  ...
  const [dealer, setDealer] = useState('HP Gas');
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const legacyDealerMap = {
        'Sri Lakshmi Gas Agency': 'HP Gas',
        'Bharat Gas Centre': 'Bharat Gas',
      };
      const savedDealerType = legacyDealerMap[savedUser.dealer] || savedUser.dealer;
      const validDealer = savedDealerType === dealer || savedUser.gasType === dealer;
